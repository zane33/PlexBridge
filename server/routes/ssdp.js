...
// CRITICAL: Enhanced robust transcode decision endpoint for Android TV long-running sessions
// This replaces the previous problematic implementation with comprehensive error handling
// to prevent HTML responses that crash Android TV clients after 30+ minutes
router.get('/video/:/transcode/universal/decision', async (req, res) => {
  const { generateRobustTranscodeDecision } = require('../utils/robustTranscodeDecision');
